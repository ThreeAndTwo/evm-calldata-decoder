...
contract CompactSwapDecoderTest is Test {
    ...
    function testDecodeCompactSwapETH() public {
        ...
        CompactSwapDecoder.swapCompactInfo memory result = decoder.decodeCompactSwap(receiver, data);
    ...
    function testDecodeCompactSwapWithZeroAddress() public {
        ...
        assertEq(result.tokenInfo.inputToken, address(0), "Invalid input token");
        assertEq(result.tokenInfo.outputToken, address(1), "Invalid output token");
    }
